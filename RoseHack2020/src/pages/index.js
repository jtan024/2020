...
>      <img src={GIF} className="animation" />
    ...
    <section id={'questions'}>
      ...
      <Question question={"How much do I have to pay?"} answer={'Rose Hack is completely free! You\'ll get a weekend\'s worth of swag, snacks, meals, drinks and a place to sleep. '}/>
      ...
      <Question question={"I am not a female. Should I still apply?"} answer={'Absolutely! All high school and undergraduate students from any background are welcome to apply!'}/>
          </div>
            <div className={'half'}>
                <Question question={'Will there be travel reimbursements?'} answer={'Unfortunately, we won\'t be able to provide travel reimbursements this year. However, participants will be provided with parking permits to park at UC Riverside for free.'}/>
                ...
                <Question question={"Can I start hacking before Rose Hack?"} answer={'All projects for Rose Hack must be made during the weekend. Planning and gathering resources before the hackathon is allowed.'}/>
        ...
        <p className={'title'} style={{position: "relative", top: '30px'}}>Still have questions? Feel free to send us a message! </p>
    </section>
